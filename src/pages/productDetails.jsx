...
const email = "Sidhanth@gmail.com";


useEffect(()=>{
   const fetchProduct = async () => {
    try {
        const response = await axios.get(`hhtp://localhost:3001/api/products/${id}`);
...
const handleIncrement = () =>
 ...
 const addtoCart = async() =>{
    try{
        const response = awaitaxios.post(`hhtp://localhost:3001/api/products/${id}`, {
        userId:email,
        productId: id,
        quantity:quantity,
    }
